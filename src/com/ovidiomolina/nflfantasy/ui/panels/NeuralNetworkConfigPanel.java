...
public class NeuralNetworkConfigPanel extends JPanel {
    ...
    private JComboBox neuralNetworkOutputType;
    ...
    private void initComponents() {
        neuralNetworkOutputType = new JComboBox(NeuralNetworkHelper.NEURAL_NETWORK_OUTPUT_TYPES);
    ...
    public String getNeuralNetworkOutputType() {
        return (String)neuralNetworkOutputType.getSelectedItem();
    }
